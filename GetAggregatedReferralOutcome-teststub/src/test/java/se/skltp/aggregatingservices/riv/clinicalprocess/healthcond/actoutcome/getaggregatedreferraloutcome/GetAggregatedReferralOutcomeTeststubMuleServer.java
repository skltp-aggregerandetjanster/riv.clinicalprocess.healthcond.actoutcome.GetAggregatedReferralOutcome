...
public class GetAggregatedReferralOutcomeTeststubMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedReferralOutcome-teststub";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedReferralOutcomeTeststubMuleServer.class);
