...
public class QueryObjectFactoryImpl implements QueryObjectFactory {
	...
	private static final JaxbUtil ju = new JaxbUtil(GetReferralOutcomeType.class);
	...
	/**
	 * Transformerar GetReferralOutcome request till EI FindContent request enligt:
	 *
	...
	public QueryObject createQueryObject(final Node node) {
		final GetReferralOutcomeType request = (GetReferralOutcomeType)ju.unmarshal(node);
