...
public class GetAggregatedReferralOutcomeMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedReferralOutcome";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedReferralOutcomeMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/GetAggregatedReferralOutcome-common.xml"
        //
